  ...
  Future<void> _analyzeImageWithGemini(File imageFile) async {
    ...
    try {
      ...
      final prompt = TextPart(
        'Analise esta foto de refeição. Identifique os alimentos presentes e estime as calorias totais de forma o mais precisa possível. '
        'Responda estritamente em formato JSON válido sem formatações adicionais com a seguinte estrutura: '
        '{"prato": "nome simples do prato ou itens principal", "calorias": 450, "detalhes": "breve descrição dos ingredientes identificados"}'
      );
      ...
      if (responseText != null) {
        final cleanJson = responseText.replaceAll('```json', '').replaceAll('
